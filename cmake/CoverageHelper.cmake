    ...
    if(NOT BUILD_TESTS)
        ...
        if(NOT TARGET CMT_CoverageTarget)
            ...
            if(CMT_COVERAGE_GCOVR)
                ...
                elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND NOT LLVM_COV_PATH)
                    message(WARNING "llvm-cov not found compiled with clang, gcovr coverage report will not be generated.")
                else()
                    # setup gcovr:
            ...
            if(CMT_COVERAGE_LCOV)
                # if(FALSE)
                if(NOT(LCOV_PATH AND GENHTML_PATH))
                    message(WARNING "lcov not found, lcov coverage report will not be generated.")
                elseif(CMAKE_CXX_COMPILER_ID STREQUAL "Clang" AND NOT LLVM_COV_PATH)
                    message(WARNING "llvm-cov not found compiled with clang, lcov coverage report will not be generated.")
                else()
                    # setup and run lcov:
